...
// 组件对外暴露一个方法，叫做 open 方法，基于open传来的参数，区分添加还是编辑
// open({}) => (传空对象时)表单无需渲染,说明是添加
// open({id,cate_name,...}) => (有数据时)表单需要渲染，说明是编辑
// open 调用后,可以打开弹窗
const editorRef = ref()
  ...
  >
    ...
    <el-form :model="formModel" ref="formRef" label-width="100px">
      ...
      <el-form-item>
        ...
        <el-button type="info" @clic="onPublish('草稿')">草稿</el-button>
      </el-form-item>
    </el-form>
  </el-drawer>
</template>
